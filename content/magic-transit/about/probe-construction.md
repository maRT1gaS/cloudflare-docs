...
<bongo:aside type="note" header="Note">  Cloudflare always attempts to send traffic over available tunnel routes with the highest priority,
  even when all configured tunnels are in an unhealthy state.</bongo:aside>
