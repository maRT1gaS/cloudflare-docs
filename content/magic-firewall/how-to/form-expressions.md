...
Rules are written as using the Cloudflare Firewall Rules language - a DSL intended to mimic Wireshark semantics. For more information, refer to the [Firewall Rules language](/firewall/cf-firewall-language).
