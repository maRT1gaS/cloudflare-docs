...
- <Code>
    state.blockConcurrencyWhile(callback<ParamType>Function()</ParamType>)
...
- <Code>
    get(key<ParamType>string</ParamType>, options<ParamType>Object</ParamType>
    <PropMeta>optional</PropMeta>)
  </Code> <Type>Promise&lt;any></Type>
  ...
  - Retrieves the value associated with the given key. The type of the returned value will be whatever was previously written for the key, or undefined if the key does not exist.
    ...
    **Supported options:**
    ...
    - <Code>
        allowConcurrency<ParamType>boolean</ParamType>
      </Code>
    ...
    - <Code>
        noCache<ParamType>boolean</ParamType>
      </Code>
...
- <Code>
    get(keys<ParamType>Array&lt;string></ParamType>, options
    <ParamType>Object</ParamType>)
  </Code> <Type>Promise&lt;Map&lt;string, any>></Type>
...
- <Code>
  ...
  - Stores the value and associates it with the given key. The value can be any type supported by the [structured clone algorithm](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Structured_clone_algorithm), which is true of most types. Keys are limited to a max size of 2048 bytes and values are limited to 32 KiB (32768 bytes).
    ...
    **Supported options:**
    ...
    - <Code>
        allowUnconfirmed<ParamType>boolean</ParamType>
      </Code>
    ...
    <bongo:aside type="note" header="Automatic write coalescing">
    ...
    <bongo:aside type="note" header="Write buffer behavior">
...
- <Code>
    put(entries<ParamType>Object</ParamType>, options
    <ParamType>Object</ParamType>
    <PropMeta>optional</PropMeta>)
  </Code> <Type>Promise</Type>
...
- <Code>
    delete(key<ParamType>string</ParamType>)
  </Code> <Type>Promise&lt;boolean></Type>
...
- <Code>
    delete(keys<ParamType>Array&lt;string></ParamType>, options
    <ParamType>Object</ParamType>
    <PropMeta>optional</PropMeta>)
  </Code> <Type>Promise&lt;number></Type>
...
- <Code>
    list(options<ParamType>Object</ParamType>)
  </Code> <Type>Promise&lt;Map&lt;string, any>></Type>
...
<bongo:aside type="note" header="ID logging">
...
<bongo:aside type="note" header="Unique IDs perform best">
...
<bongo:aside type="note" header="Name-derived IDs require global lookups at creation">
...
<bongo:aside type="note" header="E-order">
