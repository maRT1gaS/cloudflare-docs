...
2.  From **Overview**, scroll down to **Manage domain** in the right-hand menu > **Contacts**.
...
If you decide you no longer need the domain, [disable auto-renew for your account](/registrar/account-options/renew-domains/#set%E2%80%94up-automatic-renewals). Once disabled, your domain will not renew upon expiration.
...
For more details on renewals, refer to [Domain renewal](/registrar/account-options/renew-domains/).
