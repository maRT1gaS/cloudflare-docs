...
If your application uses a partial (CNAME) setup and also uses HTTP DCV validation, you will need to [change your DCV method](/ssl/edge-certificates/universal-ssl/changing-dcv-method/) to either TXT or Email.
