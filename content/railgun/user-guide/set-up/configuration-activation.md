...
It is recommended that you consult the [Testing Railgun](/railgun/user-guide/installation/#testing-railgun) section before enabling Railgun for all visitors to your site.
