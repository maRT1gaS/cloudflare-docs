...
<table>
  ...
  <tbody style="vertical-align:top">
    <tr>
      <td><a href="/rulesets-api/view/#list-existing-rulesets">List existing rulesets</a></td>
      <td><code>GET</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/view/#view-a-specific-ruleset">View a specific ruleset</a></td>
      <td><code>GET</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/view/#list-all-versions-of-a-ruleset">List all versions of a ruleset</a></td>
      <td><code>GET</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/view/#view-a-specific-version-of-a-ruleset">View a specific version of a ruleset</a></td>
      <td><code>GET</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/view/#list-rules-in-a-managed-ruleset-with-a-specific-tag">List rules in a Managed Ruleset with a specific tag</a></td>
      <td><code>GET</code></td>
      <td>
...
<table>
  ...
  <tbody style="vertical-align:top">
    <tr>
      <td><a href="/rulesets-api/create">Create ruleset</a></td>
...
<table>
  ...
  <tbody style="vertical-align:top">
    <tr>
      <td><a href="/rulesets-api/update">Update or deploy a ruleset</a></td>
      <td><code>PUT</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/add-rule">Add rule to ruleset</a></td>
      <td><code>POST</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/update-rule">Update a rule in a ruleset</a></td>
    ...
    <tr>
      <td><a href="/rulesets-api/delete-rule">Delete a rule in a ruleset</a></td>
...
<table>
  ...
  <tbody style="vertical-align:top">
    <tr>
      <td><a href="/rulesets-api/delete#delete-ruleset">Delete ruleset</a></td>
      <td><code>DELETE</code></td>
      <td>
    ...
    <tr>
      <td><a href="/rulesets-api/delete#delete-ruleset-version">Delete ruleset version</a></td>
      <td><code>DELETE</code></td>
      <td>
