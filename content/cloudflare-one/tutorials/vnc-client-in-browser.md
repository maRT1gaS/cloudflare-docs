...
2.  [Enable Cloudflare for Teams on your account](/cloudflare-one/setup/)
3.  [Connect your identity provider to Cloudflare for Teams](/cloudflare-one/identity/idp-integration/)
