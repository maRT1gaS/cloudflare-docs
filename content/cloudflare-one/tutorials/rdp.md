...
2.  Copy the file to the `systemprofile` directory created previously.
...
{{<Aside>}} <strong>IMPORTANT</strong>: Make sure you have enabled WebSockets in the "Network" section of your domain in the Cloudflare control panel:
...
2.  Navigate to **Macintosh HD > Applications**.

3.  Double click on the previously created `CF-RDP-Tunnel.command` file.
