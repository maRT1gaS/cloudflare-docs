...
If you encounter this error please [file feedback](/cloudflare-one/connections/connect-browsers/known-limitations#submitting-feedback) via the WARP client and we will investigate.
...
Safari is more susceptible to presenting this error. See [workaround](/cloudflare-one/connections/connect-browsers/known-limitations/#safari).
