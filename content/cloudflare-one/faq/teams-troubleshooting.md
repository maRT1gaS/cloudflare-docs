...
<div class="small-img">
  <img
    alt="Google Error 400"
    src="../static/documentation/faq/google-error-400.png"
  />
</div>
...
- Your requests are blocked by [Super Bot Fight Mode](https://developers.cloudflare.com/bots/get-started/pro). To resolve, make sure you set **Definitely automated** to _Allow_ in the bot fight mode settings.
